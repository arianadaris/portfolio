...
const Header = () => {
  ...
  return (
    <>
      ...
      <div className="md:border-b-[0.5px] xs:border-b-[0.5px] md:border-black xs:border-gray dark:border-white opacity-0 animate-firl animation-delay-500" />
      ...
      <div className={isOpen ? "md:border-b-[0.5px] xs:border-b-[0.5px] md:border-black xs:border-gray dark:border-white opacity-0 animate-firl animation-delay-500 flex" : "hidden"} />
    </>
  );
}
