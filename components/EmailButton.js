...
const EmailButton = () => {
  return (
    <div className="bg-[#3c3c3c] dark:bg-white rounded-100 text-white dark:text-black flex items-center md:px-8 xs:px-5 py-2 md:my-10 xs:my-4 xs:w-auto md:w-fit">
